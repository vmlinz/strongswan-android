...
public class CharonVpnService extends VpnService implements Runnable {
    ...
    public static final String KEY_CONFIGURE_CLASS_NAME = "vpn_configure_class_name";
    public static final String LOG_FILE = "charon.log";

    private String mConfigureClassName;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent != null) {
            ...
            if (bundle != null) {
                mConfigureClassName = bundle.getString(KEY_CONFIGURE_CLASS_NAME, "");
            ...
            synchronized (this) {
                try {
                    ...
                    if (mNextProfile == null) {
                        ...
                        BuilderAdapter builder = new BuilderAdapter(mCurrentProfile.getName(), mConfigureClassName);
    ...
    public class BuilderAdapter {
        ...
        private final String mConfigureClassName;
        private VpnService.Builder mBuilder;
        private BuilderCache mCache;
        private BuilderCache mEstablishedCache;

        public BuilderAdapter(String name, String configureClassName) {
            mName = name;
            mConfigureClassName = configureClassName;
        ...
        private VpnService.Builder createBuilder(String name) {
            ...
            try {
                if (!mConfigureClassName.isEmpty()) {
                    configureClass = Class.forName(mConfigureClassName);
                    Intent intent = new Intent(context, configureClass);
